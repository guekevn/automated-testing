...
describe('Debit', () => {
    it('Pembayaran debit berhasil', async () => {
        try {
            ...
            const btnDebit = await browser.$('(//android.widget.LinearLayout[@resource-id="com.mkpmobile.retail.mitramint:id/lnClick"])[2]')
            await btnDebit.click()
